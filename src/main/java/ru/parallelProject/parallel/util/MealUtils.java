...
public class MealUtils {
    ...
    public static void main(String[] args) {
        ...
        List<MealWithExceed> filteredMealWithExceeded = getFilteredMealWithExceeded(MEAL_LIST, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
    ...
    private static List<MealWithExceed> getFilteredMealWithExceeded(List<Meal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        List<MealWithExceed> mealWithExceedList = mealList.stream().filter(meal -> DateTimeUtil.isBetween(meal.getTime(), startTime, endTime))
    ...
    public static List<MealWithExceed> getWithExceeded(List<Meal> mealList, int caloriesPerDay) {
        return getFilteredMealWithExceeded(mealList, LocalTime.MIN, LocalTime.MAX, caloriesPerDay);
    }
}
